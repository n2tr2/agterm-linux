...
enum LinuxSidebarPolicy {
    ...
    /// left the sidebar or is not mapped gives up: scrolling to a hidden row is meaningless, and the
    /// selection sync that follows its reveal issues a fresh request.
